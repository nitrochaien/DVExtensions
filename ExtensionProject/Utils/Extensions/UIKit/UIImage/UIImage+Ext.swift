...
extension UIImage {
    /// Resize image with particular percentage
    ///
    /// - Parameter percentage: Input percentage
    ...
    /// - Returns: New image with size is input width and width-based calculated height
    ...
    ///
    /// - Returns: Resized image. Extra margin is added to the input image size.  So that
    ///         the final image's size will be equal to:
    ///         `CGSize(width: size.width + extraMargin * 2, height: size.height + extraMargin * 2)`
    ///
    func resizeWith(size: CGSize, extraMargin: CGFloat) -> UIImage? {
    ...
    ///
    /// - Returns: Resized image with rounded corners.
    ///
    func resizeWith(size: CGSize, radius: CGFloat) -> UIImage? {
